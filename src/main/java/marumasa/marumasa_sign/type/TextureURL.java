...
public record TextureURL(Identifier identifier, int width, int height) {
    ...
    public static final TextureURL loading = new TextureURL(
            Identifier.fromNamespaceAndPath(MarumaSign.MOD_ID, "textures/misc/loading.png"), 160, 96
    );

    // 読み込み失敗のテクスチャ
    public static final TextureURL error = new TextureURL(
            Identifier.fromNamespaceAndPath(MarumaSign.MOD_ID, "textures/misc/error.png"), 160, 96
    );
}
